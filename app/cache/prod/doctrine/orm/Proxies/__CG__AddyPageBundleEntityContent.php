 ...
 */
class Content extends \Addy\PageBundle\Entity\Content implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Addy\\PageBundle\\Entity\\Content' . "\0" . 'id', '' . "\0" . 'Addy\\PageBundle\\Entity\\Content' . "\0" . 'page');
        }
